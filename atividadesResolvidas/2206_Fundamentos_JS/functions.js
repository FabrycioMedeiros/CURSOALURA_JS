...
// 1) declara função
// FUNÇÕES PODEM RECEBER VÁRIOS TIPOS DE DADOS
                    //string
...
// 03 formas de escrever Funções no JS 

function soma(){
    //outros códigos
    //vários console.log
    // return é a ultima linha da função, após eça o Js não realiza mais a leitura do código
    return 2 + 2;
}
//console.log(soma())
